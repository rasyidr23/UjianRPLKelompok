 ...
 * @author Rasyid
 */
public class ModelTabelAnggota extends AbstractTableModel {
    private List<ModelAnggota> peminjamList;
    private String[] columnNames = {"ID", "NPM", "Nama", "Judul Buku", "Tanggal Pinjam", "Tanggal Kembali"};

    public ModelTabelAnggota(List<ModelAnggota> peminjamList) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ModelAnggota peminjam = peminjamList.get(rowIndex);
        switch (columnIndex) {
            case 0:
    ...
    public void setPeminjamList(List<ModelAnggota> peminjamList) {
        this.peminjamList = peminjamList;
