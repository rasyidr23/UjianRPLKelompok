...
public class AnggotaView extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(kembaliField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)
                            .addComponent(npmField, javax.swing.GroupLayout.Alignment.TRAILING))))
                .addGap(41, 41, 41))
            .addGroup(layout.createSequentialGroup()
                .addGap(136, 136, 136)
    ...
    JTextField idField = new JTextField(5);
    JTextField npmField = new JTextField(10);
    JTextField namaField = new JTextField(20);
    JTextField bukuField = new JTextField(20);
    JTextField pinjamField = new JTextField(10);
    JTextField kembaliField = new JTextField(10);

    // Membuat panel untuk menampung input
    ...
    panel.add(bukuField);
    panel.add(new JLabel("Tanggal Pinjam:"));
    panel.add(pinjamField);
    panel.add(new JLabel("Tanggal Kembali:"));
    panel.add(kembaliField);

    // Menampilkan dialog box dengan input fields
    int result = JOptionPane.showConfirmDialog(null, panel, 
    ...
    if (result == JOptionPane.OK_OPTION) {
        try {
            ...
            // Membuat objek ModelAnggota dengan data yang diperbarui
            ModelAnggota mahasiswa = new ModelAnggota(id, npm, nama, judulBuku, tanggalPinjam, tanggalKembali);

            // Memanggil controller untuk update data
            ...
            // Menangani error jika ID bukan angka
            JOptionPane.showMessageDialog(null, "ID harus berupa angka.", "Error", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
